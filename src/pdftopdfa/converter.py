    ...
    *,
    ...
    try:
        ...
        if level.endswith("a"):
            ...
            ocr_figure_artifact_count = tagging_result.get(
                "semantic_ocr_figure_artifacts",
                0,
            )
            if ocr_figure_artifact_count:
                review_findings.append(
                    PDFUAReviewFinding(
                        code="ocr_rejected_figure_artifact",
                        message=(
                            "Figure was marked as an Artifact because OCR text was "
                            "not trustworthy"
                        ),
